...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   := -w -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -std=gnu89 -pipe -fforce-addr 
HOSTCXXFLAGS = -O3
...
KBUILD_CFLAGS   := -w -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -pipe \
